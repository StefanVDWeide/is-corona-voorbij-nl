        ...
        <b-col >
          <div class="statistics-div">
            ...
            <span class="number-span mr-3">
              De data die op de thuis pagina te zien is komt van <b-link href="https://www.worldometers.info/coronavirus/" target="_blank">Worldometers</b-link> en <b-link href="https://www.jhu.edu/" target="_blank">Johns Hopkins University</b-link>. Beide verzameld via de <b-link href="https://github.com/disease-sh/API" target="_blank">disease.sh API</b-link>
            </span>
          </div>
        </b-col>
      </b-row>
